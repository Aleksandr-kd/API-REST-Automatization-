package api.testData.generators;
...
public class RandomCredentialsGenerator {
    ...
    public String generateUsername(int minLength, int maxLength) {
        return generateRandomString(LOWERCASE_CHARS + UPPERCASE_CHARS, minLength, maxLength);
    }
    ...
    public String generateFirstName(int minLength, int maxLength) {
        return generateRandomString(LOWERCASE_CHARS + UPPERCASE_CHARS, minLength, maxLength);
    }

    public String generateLastName(int minLength, int maxLength) {
        return generateRandomString(LOWERCASE_CHARS + UPPERCASE_CHARS, minLength, maxLength);
    }

    public String generateMobileNumber(int minLength, int maxLength) {
        return generateRandomString(NUMBERS, minLength, maxLength);
    }

    public String generateAddress(int minLength, int maxLength) {
